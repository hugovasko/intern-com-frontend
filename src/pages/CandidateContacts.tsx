    ...
    <section className="w-screen -mx-[50vw] left-[50%] relative p-8">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16 w-full">
          <h1 className="text-4xl font-bold text-gray-800 mb-6">Candidate Contacts</h1>
          <p className="max-w-3xl mx-auto text-xl font-semibold text-gray-600 mb-8">
            Connect with us and take the first step towards your career journey. We're excited to
            learn more about you and your aspirations.
          </p>
